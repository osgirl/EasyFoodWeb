...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when('/scroll', {templateUrl: '/public/scroll.html', reloadOnSearch: false});
    $routeProvider.when('/toggle', {templateUrl: '/public/toggle.html', reloadOnSearch: false});
    $routeProvider.when('/tabs', {templateUrl: '/public/tabs.html', reloadOnSearch: false});
    $routeProvider.when('/accordion', {templateUrl: '/public/accordion.html', reloadOnSearch: false});
    $routeProvider.when('/overlay', {templateUrl: '/public/overlay.html', reloadOnSearch: false});
    $routeProvider.when('/forms', {templateUrl: '/public/forms.html', reloadOnSearch: false});
    $routeProvider.when('/dropdown', {templateUrl: '/public/dropdown.html', reloadOnSearch: false});
